...
exports.BinaryRectanglePopulation = void 0;
const canvas_1 = require("canvas");
const GA_1 = require("../../GA");
const BinaryRectangleIndividual_1 = require("./BinaryRectangleIndividual");
 ...
 */
class BinaryRectanglePopulation extends GA_1.Population {
    /**
    ...
    constructor(individualCount, refImage, mutationRate) {
        super(individualCount, 4, mutationRate, BinaryRectangleIndividual_1.BinaryRectangleIndividual);
        // Sets Binary Rectangle Individuals reference image width and height
        BinaryRectangleIndividual_1.BinaryRectangleIndividual.imageWidth = refImage.width;
        BinaryRectangleIndividual_1.BinaryRectangleIndividual.imageHeight = refImage.height;
    ...
    mutate() {
        for (let i = 0; i < this.individualCount; i++) {
            ...
            if (Math.random() < this.mutationRate)
                this.individuals[i].genes[0] = Math.round(Math.random() * BinaryRectangleIndividual_1.BinaryRectangleIndividual.imageWidth);
            // Mutates upper left corner y coordinate
            if (Math.random() < this.mutationRate)
                this.individuals[i].genes[1] = Math.round(Math.random() * BinaryRectangleIndividual_1.BinaryRectangleIndividual.imageHeight);
            // Mutates rectangle's width    
            if (Math.random() < this.mutationRate)
                this.individuals[i].genes[2] = Math.round(Math.random() * BinaryRectangleIndividual_1.BinaryRectangleIndividual.imageWidth);
            // Mutates rectangle's height    
            if (Math.random() < this.mutationRate)
                this.individuals[i].genes[3] = Math.round(Math.random() * BinaryRectangleIndividual_1.BinaryRectangleIndividual.imageHeight);
        }
        return this.individuals;
    }
...
exports.BinaryRectanglePopulation = BinaryRectanglePopulation;
