...
export interface _Context2D {
    fillStyle: string | CanvasGradient | CanvasPattern   // Context's fill style
    strokeStyle: string | CanvasGradient | CanvasPattern // Context's stroke style
    lineWidth: number                                    // Context's line width
